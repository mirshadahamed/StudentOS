...
const TaskSchema = new mongoose.Schema({
  ...
  subtasks:    { type: [SubtaskSchema], default: [] },   // user-defined subtasks
  createdAt:   { type: Date, default: Date.now },
  updatedAt:   { type: Date, default: Date.now },
});

// ─── Pre-save: sync status, derive progress from subtasks, calc aiScore ───────
TaskSchema.pre('save', function () {
  this.updatedAt = new Date();

  // If subtasks exist → derive progress from their completion ratio
  ...
  // AI Score: days urgency (0–70) + priority bonus (High +30, Med +15, Low +0)
